...
Unzip the `data.zip` file inside your `fa20-proj6-yourname` directory. You should now have a `data/` directory in the root of your `fa20-proj6-yourname` directory.

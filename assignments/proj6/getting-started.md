...
This project is due **Monday, 12/6/2021 at 11:59PM PST (GMT-8)**. It is worth 6% of your overall grade in the class. 100% of your grade will come from the public tests released with the data set.
...
Unzip the `data.zip` file inside your `fa21-proj6-yourname` directory. You should now have a `data/` directory in your `fa21-proj6-yourname` directory.

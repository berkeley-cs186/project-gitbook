...
At this point you should be able to run SQLite and view the database using either `./sqlite3 -header -column lahman.db` \(if in the previous section you downloaded a precompiled binary\) or `sqlite3 -header -column lahman.db` otherwise.

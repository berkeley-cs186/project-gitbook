...
You should make sure that all code you modify belongs to files with `TODO(proj3)` comments in them \(e.g. don't add helper methods to `DataBox`\). Here is a comprehensive list of the files you may modify:

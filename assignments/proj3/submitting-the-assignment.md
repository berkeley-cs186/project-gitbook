...
If you haven't yet already be sure to fill out [this form](https://forms.gle/gHif9nNmHoJSpKB37) so we know who you're working with. When submitting to Gradescope remember to add your partner to the submission so they can get credit.

Alternatively you can submit separately if you would like. Slip days will be deducted individually. For example: You submit on time, but your partner submits a day late. Your partner will have to use a slip day or will receive a late penalty on the project \(but you will not\).

**It is your responsibility to make sure you've been added properly to any group submissions** **in order to get credit.**
